...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('ask')
        .setDescription('Ask the AI about Lil Gargs')
    ...
    async execute(interaction) {
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .setFooter({ 
                    text: `Asked by ${username}${result.documentsUsed > 0 ? ` • Used ${result.documentsUsed} document(s)` : ''}`,
            ...
            // Log the interaction
            logger.info(`AI question from ${username} (${userId}): "${question}" - Response length: ${result.response.length}`);
            ...
            const errorEmbed = new EmbedBuilder()
                ...
                .addFields(
                    { name: 'Question', value: interaction.options.getString('question'), inline: false }
                )
                .setFooter({ 
